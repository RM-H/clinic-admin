...
import {addDashboard, adduserinfo,} from "../slices/UserSlice";
...
const MainLayout = () => {
  ...
  return(
      <>
        <div className='is-flex is-flex-direction-column is-align-items-center mx-auto clrthree'  style={{width: '100vw' , height:'100vh'}}>
            <Navbar/>
